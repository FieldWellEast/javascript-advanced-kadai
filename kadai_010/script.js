  ...
  $('#agree').click(function () {
    ...
    function inputCheck() {
     ...
     if ($('#tel').val() != '' && $('#tel').val().indexOf('-') == -1) {
       ...
       //セレクトボックスのフォーカスが外れたとき、都道府県が選択されていない場合は、セレクトボックスが赤色になる
       //送信ボタンをクリックしたとき、都道府県が選択されていない場合は、セレクトボックスが赤色になる
       //送信ボタンをクリックしたとき、都道府県が選択されていない場合は、「都道府県を選択してください」とアラートが表示される
